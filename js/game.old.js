...
function preload() {
	...
	this.game.load.tilemap('levelone', 'assets/tilemaps/levelone.json', null, Phaser.Tilemap.TILED_JSON);
	this.game.load.image('tiles01', 'assets/images/tiles01.png');
	this.game.load.image('background', 'assets/images/sky.png');
	this.game.load.image('textbubble', 'assets/images/textbubble.png');

	this.game.load.image('hills', 'assets/images/hills.png');
	this.game.load.image('trees', 'assets/images/trees.png');
	this.game.load.image('heart', 'assets/images/heart.png');
	this.game.load.image('hudlemon', 'assets/images/hudlemon.png');
	
	this.game.load.image('house', 'assets/images/house.png');
	this.game.load.image('lemonadestand', 'assets/images/lemonadestand.png');
	this.game.load.image('rottenlemon', 'assets/images/rottenlemon.png', 32, 32);

	this.game.load.spritesheet('lemon', 'assets/images/lemon.png', 32, 32);

	this.game.load.spritesheet('player', 'assets/images/player.png', 32, 32);
	this.game.load.spritesheet('bob', 'assets/images/bob.png', 32, 32);
	this.game.load.spritesheet('george', 'assets/images/george.png', 32, 32);   
...
function create() {
   ...
   //nextLevel = 'levelTwoState';
	...
	// Set collisions
	map.setCollision(0, 4, true, layer);
