...
SideScroller.Game.prototype = {
  ...
  create: function() {
    ...
    this.map.addTilesetImage('tiles01');

    //create layers
    this.backgroundlayer = this.map.createLayer('layer01');
    this.blockedLayer = this.map.createLayer('layer02');

    //collision on blockedLayer
    this.map.setCollisionBetween(1, 5000, true, 'objectlayer');
 ...
 //find objects in a Tiled layer that containt a property called "type" equal to a certain value
  ...
  createCoins: function() {
    ...
    var result = this.findObjectsByType('lemon', this.map, 'objectlayer');
